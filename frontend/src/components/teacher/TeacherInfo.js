            ...
            <div className="languages-and-availability">
              ...
              <div className="availability">
                ...
                <div className="availability__item">
                  {data.teaching_type &&
                    data.teaching_type.data &&
                    data.teaching_type.data.includes("online") && (
                      <div>
                        <button
                  ...
                  {data.teaching_type &&
                    data.teaching_type.data &&
                    data.teaching_type.data.includes("in-person") && (
                      <div>
                        <button
                          className="button button--primary"
                          id={`InPerson-${data.id}`}
                        >
                          <span className="icon-car white"></span>
                          In home
                        </button>
                        ...
                        <Tooltip
                          ...
                          target={`InPerson-${data.id}`}
                          toggle={toggleInPerson}
                          className="tooltip-styte"
                        >
                          {`The teacher is traveling to your home (
                        ${
                          data.teaching_distance === null
                            ? "Up to 5miles"
                            : `${
                                data.teaching_distance &&
                                data.teaching_distance.formatted_data
                              }`
                        }
                      around ${data.city})`}
                        </Tooltip>
