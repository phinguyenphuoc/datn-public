...
function Student({ handleSubmit, userStudentInfo, onOpenModalUpdateAvatar }) {
  const storeStudentUpdateProfile = useSelector(
    (store) => store.student.updateProfile
  );
  const isSubmitting = storeStudentUpdateProfile.loading;
  ...
  React.useEffect(() => {
    setForm({
      ...form,
      firstName: userStudentInfo.first_name || "",
      lastName: userStudentInfo.last_name || "",
    });
    setDayOfBirth(
      userStudentInfo.birth_date
        ? moment(userStudentInfo.birth_date)
        : new Date()
    );
    ...
    <StyledStudent>
      <div className="container">
        <div className="mystudent__inner__text">
          ...
          <p className="text-color">{`${userStudentInfo.first_name} ${userStudentInfo.last_name}`}</p>
        </div>
        <div className="Student__inner">
          <div className="card">
            <div className="avatar" onClick={onOpenModalUpdateAvatar}>
              <img src={userStudentInfo.avatar || user} alt="avatar" />
            ...
            <h4>{`${userStudentInfo.first_name} ${userStudentInfo.last_name}`}</h4>
            {/* <p className="location">
              {userStudentInfo.address && userStudentInfo.address[2]}
            </p> */}
          </div>
                ...
                {/* <div className="form__item">
                  <div className="form__item__inner">
                    ...
                    <DatePicker
                      ...
                      maxDate={moment().subtract(4, "year")}
