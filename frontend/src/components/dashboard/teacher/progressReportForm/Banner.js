...
function Banner({ dataStudentSelect }) {
  return (
    <StyledBanner>
      <div className="container">
        <div className="banner__text">
          ...
          <p className="text-color">Progress report form</p>
        </div>
        <div className="banner__progress">
          <div className="banner__progress__left">
            ...
            <div className="banner__progress__text">
              ...
              <h4>
                Date: <span>{moment().format("MMMM, YYYY")}</span>
              </h4>
              <p className="text-border2"></p>
              <h4>
                Student name:{" "}
                <span>{`${dataStudentSelect.first_name} ${dataStudentSelect.last_name}`}</span>
              </h4>
            </div>
          </div>
        </div>
